...
use Lightit\Backoffice\Flights\App\Requests\ListFlightsRequest;
...
{
    public function __invoke(ListFlightsRequest $request, ListFlightsAction $action): JsonResponse
    {
